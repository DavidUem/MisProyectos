...
public class MainActivity extends ListActivity {
    ...
    private String practicas[] = {"GoogleJSON","Actividad_Intent_1","Pulsame","Intent_2","Intent_3","Intent_devolverdato",
            "Share_actionbar", "Progress_bar","BroadcastReceiver","Notificacion","ImplicitIntents"};
